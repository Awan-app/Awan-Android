...
class Navigator(val state: NavigationState) {
    ...
    /**
     * Replaces the entire navigation state with a new root.
     * Useful for boundaries like Splash -> Onboarding or Login -> Home.
     */
    fun replaceAll(key: Route) {
        ...
        if (subStack != null) {
            ...
            // If replacing with a non-top level key that was never initialized
