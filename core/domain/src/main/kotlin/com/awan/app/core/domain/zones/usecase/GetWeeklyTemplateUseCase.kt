...
class GetWeeklyTemplateUseCase @Inject constructor(
    private val zonesRepository: ZonesRepository
) {
    suspend operator fun invoke(templateId: String): Result<WeeklyTemplate> =
        zonesRepository.getTemplate(templateId)
}
