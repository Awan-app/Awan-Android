...
fun AwanMascot(
    ...
    val drawable = when (expression) {
        ...
        MascotExpression.Curious -> R.drawable.awan_mascot_curious
        MascotExpression.Celebrate -> R.drawable.awan_mascot_celebrate
        MascotExpression.Idle -> R.drawable.awan_mascot_idle
    }
